...
//        dataSource.setCompression("lz4");
    ...
    public KeyValuePersistenceSettings persistenceSettings(String fileName) {
...
//        ClassPathResource classPathResource = new ClassPathResource("persisence/clientPublishMessage.xml");
    ...
    public CassandraCacheStoreFactory cassandraCacheStoreFactory(String fileName) {
        CassandraCacheStoreFactory factory = new CassandraCacheStoreFactory();
        factory.setDataSource(dataSource());
        factory.setPersistenceSettings(persistenceSettings(fileName));
        return factory;
    }
