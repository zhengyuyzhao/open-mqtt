...
public class IgniteProperties {
	...
	private int systemThreadPoolSize = 32;

	private int queryThreadPoolSize = 32;

	private int stripedPoolSize = 32;

	private int publicThreadPoolSize = 32;

	private int serviceThreadPoolSize = 32;
