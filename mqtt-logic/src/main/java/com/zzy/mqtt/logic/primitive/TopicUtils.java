...
package com.zzy.mqtt.logic.primitive;
...
public class TopicUtils {
    ...
    public static String normalizeSecondTopic(String secondTopic) {
        if (StrUtil.isBlank(secondTopic)) {
            return null;
        }
    ...
    public static boolean isMatchNew(String topic, String topicFilter) {
        return isMatch(topic, topicFilter) || isMatch(topicFilter, topic);
    }
